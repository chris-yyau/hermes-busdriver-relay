...
Workers produce draft evidence; Hermes verifies evidence. Hermes routes work and may operate explicit Delivery Mode only when the user asks; ClaudeCode/Busdriver remains the sole canonical finalization authority.
