...
→ after merge, read live PR state and branch deletion state
→ attempt release while still on topic branch if possible
→ if release misses after base checkout, recreate topic branch at saved PR head
