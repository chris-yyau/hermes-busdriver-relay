...
OpenCode+Go = secondary draft-adapter/sidecar candidate, read-only/candidate until proven by separate smoke+contract work
...
Pi = deferred; do not build it into the current pipeline unless a concrete OpenCode+Go/Hermes capability gap appears
