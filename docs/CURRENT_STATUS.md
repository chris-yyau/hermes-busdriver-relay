...
PYTHONDONTWRITEBYTECODE=1 uvx --from pytest pytest tests/contract/test_skill_references.py tests/contract/test_relay_brief.py -q -p no:cacheprovider: 29 passed
PYTHONDONTWRITEBYTECODE=1 uvx --from pytest pytest tests/contract -q -p no:cacheprovider: 410 passed
